 ...
 * @example {"displayName":"sampleAlertingProfile","eventTypeFilters":[{"predefinedEventFilter":{"eventType":"OSI_HIGH_CPU","negate":true}},{"customEventFilter":{"customDescriptionFilter":{"caseInsensitive":false,"enabled":false,"negate":true,"operator":"CONTAINS","value":"filterValue"},"customTitleFilter":{"caseInsensitive":true,"enabled":true,"negate":false,"operator":"EQUALS","value":"filterValue"}}}],"id":"12345678-abcd-1234-abcd-1234567890ab","mzId":"1","rules":[{"delayInMinutes":60,"severityLevel":"AVAILABILITY","tagFilter":{"includeMode":"INCLUDE_ALL","tagFilters":[{"context":"AWS","key":"tagKey","value":"tagValue"}]}}]}
 */
 ...
 * @example {"allowedBeaconOrigins":[{"domainNameMatcher":"EQUALS","domainNamePattern":"dynatrace.com"}],"metadata":{"clusterVersion":"Mock version","configurationVersions":[4,2]}}
 */
 ...
 * @example {"applicationIdentifier":"APPLICATION-123456","filterConfig":{"applicationMatchTarget":"DOMAIN","applicationMatchType":"EQUALS","pattern":"myapp.example.com"},"id":"12345678-abcd-1234-abcd-1234567890ab","metadata":{"clusterVersion":"Mock version","configurationVersions":[4,2]},"name":"uniqueName"}
 */
 ...
 * @example {"hostDetectionHeaders":["X-Host","X-Forwarded-Host"],"metadata":{"clusterVersion":"Mock version","configurationVersions":[4,2]}}
 */
...
export interface AutoTagRule {
  ...
  normalization?: "LEAVE_TEXT_AS_IS" | "TO_LOWER_CASE" | "TO_UPPER_CASE" | null;
...
export interface AwsCredentialsConfig {
  ...
  /**
   * **Deprecated**. To manage services use [/aws/credentials/{id}/services](https://dt-url.net/l022s6v) operation. Built-in services are not supported here.
   *
...
export interface AwsMonitoredServicesDto {
  /** Metadata useful for debugging */
  metadata?: ConfigurationMetadata;
...
export interface AzureCredentials {
  ...
  /**
   * **Deprecated**. To manage services use [/azure/credentials/{id}/services](https://dt-url.net/1w62s27) operation. Built-in services are not supported here.
   *
...
export interface AzureMonitoredServicesDto {
  /** Metadata useful for debugging */
  metadata?: ConfigurationMetadata;
   ...
   * List of metrics can be skipped (set to null), resulting in recommended (default) set of metrics and dimensions being chosen for monitoring. For built-in services, adjusting the list of metrics is not supported, therefore it needs to be null.
   */
  services: AzureSupportingService[];
}
 ...
 * @example {"applicationIdentifier":"MOBILE_APPLICATION-1234","dimensions":[{"dimension":"GEOLOCATION","topX":20}],"enabled":true,"metricKey":"calc:apps.mobile.mymetric","metricType":"USER_ACTION_DURATION","name":"MyMetric","userActionFilter":{"country":"GEOLOCATION-1234","hasHttpError":true,"osVersion":"OS-1234"}}
 */
 ...
 * @example {"dimensions":[{"dimension":"Location"}],"enabled":true,"filter":{"event":"SYNTHETIC_TEST_STEP-1234","hasError":true},"metric":"UserActionDuration","metricKey":"calc:synthetic.browser.mymetric","monitorIdentifier":"SYNTHETIC_TEST-1234","name":"MyMetric"}
 */
 ...
 */
export interface CloudSupportedService {
 ...
 */
export interface CloudSupportedServicesList {
  /** List of supported services metadata */
  services?: CloudSupportedService[];
}
...
/**
 * @example {"enabled":true,"name":"CustomService","queueEntryPoint":false,"rules":[{"className":"com.your.company.ClassName","enabled":true,"methodRules":[{"argumentTypes":["java.lang.String"],"methodName":"AMethod","returnType":"void"}]}]}
 */
 ...
 */
export interface DashboardGenericTagFilter {
...
* @example {"dashboardId":"8dd67562-8bf5-4a09-830d-4e0ca992abd6","enabled":"true","id":"337d883e-98c3-4dac-b8f2-1a9cdbd05969","subscriptions":{"MONTH":["demo@email.com","demo2@email.com"],"WEEK":["demo@email.com"]},"type":"DASHBOARD"}
*/
...
export interface DataExplorerFilter {
  ...
  filter?: string;
  filterOperator?: "AND" | "NOT" | "OR";
  filterType?: "DIMENSION" | "ENTITY_ATTRIBUTE" | "ID" | "NAME" | "TAG";
  globalEntity?: string;
  nestedFilters?: { empty?: boolean };
...
export interface DataExplorerQuery {
  ...
  /** Filter for data explorer queries. */
  filterBy: DataExplorerFilter;

  /** The fold transformation */
  foldTransformation?: "LAST_VALUE" | "TOTAL";

  /** Generated metric selector */
  generatedMetricSelector?: string;
  ...
  timeAggregation: "AVG" | "COUNT" | "DEFAULT" | "MAX" | "MEDIAN" | "MIN" | "SUM" | "VALUE";

  /** TimeShift for data explorer queries. */
  timeShift?: DataExplorerTimeShift;
}

/**
 * Configuration for the queries
 */
export interface DataExplorerQuerySettings {
 ...
 */
export type DataExplorerTile = Tile & {
  customName?: string;
  metricExpressions?: string[];
  queries?: DataExplorerQuery[];
  queriesSettings?: DataExplorerQuerySettings;
  visualConfig?: VisualizationConfiguration;
};

/**
 * TimeShift for data explorer queries.
 */
export interface DataExplorerTimeShift {
  /** @format int32 */
  factor?: number;
 ...
 */
export interface DexpFilterCriterion {
  evaluator?: "EQ" | "IN" | "NE" | "PREFIX";
  matchExactly?: boolean;
  value?: string;
}

export interface DexpFilterRelationship {
  ...
  type?: "fromRelationship" | "toRelationship";
}
...
export interface DynamicFilters {
  ...
  genericTagFilters: DashboardGenericTagFilter[];
}
...
*/
export type EndsWithCompareOperation = CompareOperation & { ignoreCase?: boolean; negate?: boolean; values?: string[] };
...
*/
export type EqualsCompareOperation = CompareOperation & { ignoreCase?: boolean; negate?: boolean; values?: object[] };
...
/**
 * @example {"activeGate":{"id":"7835970235169136995","name":"ActiveGate Host Name"},"enabled":true,"hostId":"HOST-01A7DEFA5340A86D","id":"custom.remote.python.demo","properties":{"dropdownProperty":"three","password":"","serverIp":"127.0.0.1","username":"dynatrace"},"useGlobal":false}
 */
 ...
 * @example {"configurationsList":[{"id":"HOST-E1550E0AED6A572F"}],"nextPageToken":"LlUdYmu5S2MfX/ppfCInR9M=","totalResults":9}
 */
...
/**
 * @example {"extensions":[{"id":"custom.python.connectionpool","name":"Connection Pool","type":"ONEAGENT"}],"nextPageToken":"LlUdYmu5S2MfX/ppfCInR9M=","totalResults":9}
 */
 ...
 * @example {"nextPageToken":"LlUdYmu5S2MfX/ppfCInR9M=","states":[{"endpointId":"null","extensionId":"custom.python.connectionpool","hostId":"HOST-01A7DEFA5340A86D","processId":"PROCESS_GROUP_INSTANCE-2182DF2E20E3E067","state":"OK","stateDescription":"","timestamp":1578578108213,"version":"1.82"}],"totalResults":9}
 */
 ...
 * @example {"conditions":[{"attribute":"SERVICE_NAME","predicate":{"ignoreCase":false,"type":"STRING_STARTS_WITH","values":["shp","stg_shp"]}}],"description":"for requests from shipping module","enabled":true,"fdpId":"FDP_9","id":"R_5","name":"shipping"}
 */
 ...
 */
export type FdpTagDoubleEquals = FdpTagPredicate & { negated?: boolean; value?: number };

/**
 * The predicate of the `DOUBLE_EXISTS` type. It checks whether the tag  exists
 */
export type FdpTagDoubleExists = FdpTagPredicate & { negated?: boolean };
 ...
 */
export type FdpTagIntegerEquals = FdpTagPredicate & { negated?: boolean; value?: string };

/**
 * The predicate of the `INTEGER_EXISTS` type. It checks whether the tag  exists
 */
export type FdpTagIntegerExists = FdpTagPredicate & { negated?: boolean };
 ...
 */
export type FdpTagStringContainsSubstring = FdpTagPredicate & {
  ignoreCase?: boolean;
  negated?: boolean;
  value?: string;
};
 ...
 */
export type FdpTagStringEndsWith = FdpTagPredicate & { ignoreCase?: boolean; negated?: boolean; value?: string };

/**
 * The predicate of the `STRING_EQUALS` type. It checks whether the tag (which is a string) equals the reference value.
 */
export type FdpTagStringEquals = FdpTagPredicate & { ignoreCase?: boolean; negated?: boolean; value?: string };

/**
 * The predicate of the `STRING_EXISTS` type. It checks whether the tag  exists
 */
export type FdpTagStringExists = FdpTagPredicate & { negated?: boolean };

/**
 * The predicate of the `STRING_STARTS_WITH` type. It checks whether the tag (which is a string) starts with the reference value.
 */
export type FdpTagStringStartsWith = FdpTagPredicate & { ignoreCase?: boolean; negated?: boolean; value?: string };
...
*/
export type FilterableEntityTile = Tile & { chartVisible?: boolean; filterConfig?: CustomFilterConfig };
 ...
 * @example {"frequentIssueDetectionApplicationEnabled":true,"frequentIssueDetectionInfrastructureEnabled":true,"frequentIssueDetectionServiceEnabled":true}
 */
 ...
 * @example {"id":"custom.remote.python.demo","properties":[{"defaultValue":"127.0.0.1","key":"serverIp","type":"STRING"},{"defaultValue":"","key":"password","type":"PASSWORD"},{"defaultValue":"dynatrace","key":"username","type":"STRING"},{"defaultValue":"one","dropdownValues":["one","two","three"],"key":"dropdownProperty","type":"DROPDOWN"}]}
 */
 ...
 */
export interface GraphChartSettings {
 ...
 * @example {"hostGroup":{"meId":"HOST_GROUP-CF1DA380B3A53F17","name":"example host group"},"id":"HOST-0000000000000000","managementZones":[{"id":"000000000000000000","name":"example zone"}],"name":"example host","tags":["tagA","tagB"]}
 */
...
*/
export type IpInRangeCompareOperation = CompareOperation & { lower?: string; negate?: boolean; upper?: string };
 ...
 * @example {"actionType":"Load","domain":"test.com","name":"Loading of page /example"}
 */
 ...
 * @example {"keyUserActionList":[{"actionType":"Load","domain":"test.com","meIdentifier":"APPLICATION_METHOD-1234","name":"Loading of page /example"}]}
 */
 ...
 * @example {"active":true,"displayName":"Sample metric","logSourceFilters":[{"hostFilters":["HOST-066703AD79C38DB5"],"osTypes":[],"pathDefinitions":[{"definition":"/var/log/sample.log","type":"FIXED"}],"sourceEntities":["PROCESS_GROUP_INSTANCE-63FC6E7C73DC893F"]}],"metricKey":"calc:log.metric","metricValueType":"OCCURRENCES","searchString":"\"memory fault\"","unit":"HOUR","unitDisplayName":""}
 */
 ...
 * @example {"description":"sampleDescription","dimensionalRules":[{"appliesTo":"METRIC","conditions":[{"conditionType":"DIMENSION","key":"alwaysRequired","ruleMatcher":"EQUALS","value":"requiredForDimension_forbiddenForMetricKeyAndLogFileName"}],"enabled":true}],"entitySelectorBasedRules":[{"enabled":true,"entitySelector":"type(HOST) AND cpuCores(4)"}],"name":"sampleManagementZone","rules":[{"conditions":[{"comparisonInfo":{"caseSensitive":false,"negate":false,"operator":"BEGINS_WITH","type":"STRING","value":"sample"},"key":{"attribute":"SERVICE_DATABASE_NAME"}},{"comparisonInfo":{"negate":false,"operator":"EXISTS","type":"STRING"},"key":{"attribute":"SERVICE_WEB_SERVER_NAME"}},{"comparisonInfo":{"caseSensitive":false,"negate":false,"operator":"BEGINS_WITH","type":"STRING","value":"sample"},"key":{"attribute":"PROCESS_GROUP_CUSTOM_METADATA","dynamicKey":{"key":"kubernetes.io/limit-ranger","source":"KUBERNETES"},"type":"PROCESS_CUSTOM_METADATA_KEY"}}],"enabled":true,"propagationTypes":["SERVICE_TO_HOST_LIKE"],"type":"SERVICE"}]}
 */
...
export interface MetricEvent {
   ...
   */
  disabledReason?: "METRIC_DEFINITION_INCONSISTENCY" | "NONE" | "TOO_MANY_DIMS";
 ...
 * @example {"endpointId":"-8213819843595439277","pluginId":"custom.remote.python.demo","state":"ERROR_AUTH","stateDescription":"Could not authorize","timestamp":1556199097994,"version":"1.0.0"}
 */
 ...
 */
export type ProblemTile = Tile & { entitySelector?: string; problemSelector?: string };
 ...
 * @example {"activeGatePluginModule":{"id":"-8844900174269363000"},"enabled":true,"id":"-2183662974968812535","name":"Demo endpoint","pluginId":"custom.remote.python.demo","properties":{"dropdownProperty":"two","password":"","serverIp":"127.0.0.1","username":"dynatrace"}}
 */
...
*/
export type RemoveNumbersTransformation = TransformationBase & { includeHexNumbers?: boolean; minDigitCount?: number };
 ...
 * @example {"values":[{"dashboardId":"9eee7ed6-a125-4d9d-bfa7-afdb3404cb36","id":"337d883e-98c3-4dac-b8f2-1a9cdbd05969","type":"DASHBOARD"},{"dashboardId":"26ccd360-828c-4d83-a65e-040ddc31e8f6","id":"b059e372-0b35-4d44-869b-95c326748848","type":"DASHBOARD"}]}
 */
 ...
 * @example {"recipients":["demo@email.com","demo2@email.com"],"schedule":"WEEK"}
 */
 ...
 * @example {"conditions":[{"attribute":"WEBREQUEST_URL_PATH","comparisonInfo":{"caseSensitive":false,"comparison":"BEGINS_WITH","negate":false,"type":"STRING","value":"/url"}}],"enabled":true,"namingPattern":"renamed request"}
 */
 ...
 * @example {"binary":[".exe",".zip"],"image":[".jpg",".png",".gif",".jpeg",".bmp",".svg",".ico",".woff",".ttf",".otf"]}
 */
 ...
 */
export type SlackNotificationConfig = NotificationConfig & { channel?: string; title?: string; url?: string };
 ...
 * @example {"values":[{"description":"Dynatrace entity 1 for the REST API example","id":"6a98d7bc-abb9-44f8-ae6a-73e68e71812a","name":"Dynatrace entity 1"},{"id":"ee70f7d3-9a4e-4f5f-94d2-c9d6156f1618","name":"Dynatrace entity 2"},{"id":"8cdabe77-9e1a-4be8-b3df-269dd6fa9d7f"}]}
 */
...
export interface UserActionDetails {
  ...
  matchEntity?: "ActionName" | "PageUrl";
...
export interface VisualizationConfiguration {
  ...
  global?: VisualizationGlobalProperties;
 ...
 * Visualization global configuration
 */
export interface VisualizationGlobalProperties {
  hasTrendline?: boolean;
  hideLegend?: boolean;
  seriesType?: "AREA" | "COLUMN" | "LINE" | "STACKED_AREA" | "STACKED_COLUMN";
  theme?: "BLUE" | "DEFAULT" | "GRAY" | "GREEN" | "ORANGE" | "PURPLE" | "RED" | "ROYALBLUE" | "TURQUOISE" | "YELLOW";

  /** Thresholds for Visualization */
  threshold?: VisualizationThreshold;
}
...
export interface VisualizationSerieOverride {
  color: string;
  name: string;
}
...
export interface VisualizationThresholdRule {
  color: string;
 ...
 * @example {"applicationIdentifier":"APPLICATION-1234","dimensions":[{"dimension":"GeoLocation","topX":20}],"enabled":true,"metricDefinition":{"metric":"UserActionDuration"},"metricKey":"calc:apps.web.mymetric","name":"MyMetric","userActionFilter":{"browserType":"BROWSER-1234","country":"GEOLOCATION-1234","loadAction":true}}
 */
 ...
 * @version 1.0
 * @baseUrl https://joh43990.sprint.dynatracelabs.com/api/config/v1
 *
 ...
 */
export class internalConfig extends APIBase {
  alertingProfiles = {
    /**
     * No description
     *
  ...
  aws = {
     ...
     * @request GET:/aws/credentials/{id}/services
     */
    getAwsServicesConfig: (id: string, params: RequestParams = {}) =>
      this.request<AwsMonitoredServicesDto, any>({
        path: `/aws/credentials/${id}/services`,
        method: "GET",
        ...params,
      }),
     ...
     * @request PUT:/aws/credentials/{id}/services
     */
    updateAwsServicesConfig: (id: string, data: AwsMonitoredServicesDto, params: RequestParams = {}) =>
      this.request<void, ErrorEnvelope>({
        path: `/aws/credentials/${id}/services`,
        method: "PUT",
        body: data,
     ...
     * @request POST:/aws/credentials/{id}/services/validator
     */
    validateUpdateAwsServicesConfig: (id: string, data: AwsMonitoredServicesDto, params: RequestParams = {}) =>
      this.request<void, ErrorEnvelope>({
        path: `/aws/credentials/${id}/services/validator`,
        method: "POST",
        body: data,
        ...params,
      }),
    ...
    /**
     * AWS credentials configuration \
     * `GET:/aws/supportedServices` \
     * Gets the list of AWS supported services \
     * 
     * ---
     * @returns You can use this list for adding services to AWS credentials
     */
    getSupportedServices: (params: RequestParams = {}) =>
      this.request<CloudSupportedServicesList, any>({
        path: `/aws/supportedServices`,
        method: "GET",
        ...params,
      }),
  };
  azure = {
     ...
     * @request GET:/azure/credentials/{id}/services
     */
    getAzureServicesConfig: (id: string, params: RequestParams = {}) =>
      this.request<AzureMonitoredServicesDto, any>({
        path: `/azure/credentials/${id}/services`,
        method: "GET",
        ...params,
      }),
     ...
     * @request PUT:/azure/credentials/{id}/services
     */
    updateAzureServicesConfig: (id: string, data: AzureMonitoredServicesDto, params: RequestParams = {}) =>
      this.request<void, ErrorEnvelope>({
        path: `/azure/credentials/${id}/services`,
        method: "PUT",
        body: data,
     ...
     * @request POST:/azure/credentials/{id}/services/validator
     */
    validateAzureServicesConfig: (id: string, data: AzureMonitoredServicesDto, params: RequestParams = {}) =>
      this.request<void, ErrorEnvelope>({
        path: `/azure/credentials/${id}/services/validator`,
        method: "POST",
        body: data,
        ...params,
      }),
    ...
    /**
     * Azure credentials configuration \
     * `GET:/azure/supportedServices` \
     * Gets the list of Azure supported services \
     * 
     * ---
     * @returns You can use this list for adding services to Azure credentials
     */
    getSupportedServices1: (params: RequestParams = {}) =>
      this.request<CloudSupportedServicesList, any>({
        path: `/azure/supportedServices`,
        method: "GET",
        ...params,
      }),
  };
  ...
  dashboards = {
     ...
     * @request GET:/dashboards/migrateAll
     */
    migrateAllDashboard: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/dashboards/migrateAll`,
        method: "GET",
        ...params,
      }),
     ...
     * @request PUT:/dashboards/{dashboardId}/migrate
     */
    migrateDashboard: (dashboardId: string, params: RequestParams = {}) =>
      this.request<void, ErrorEnvelope>({
        path: `/dashboards/${dashboardId}/migrate`,
        method: "PUT",
        ...params,
      }),
  ...
  hosts = {
     ...
     * 
     * ---
     * @returns Deprecated. Manage host monitoring settings via the [Settings endpoint](index.jsp?urls.primaryName=Environment%20API%20v2#/Settings%20-%20Objects) with schemaId `builtin:host.monitoring` instead. Gets the monitoring configuration of OneAgent on the specified host
     * @deprecated
     */
    ...
    /**
     * OneAgent on a host \
     * `POST:/hosts/{id}/monitoring/validator` \
     * Deprecated. Manage host monitoring settings via the environment API v2 settings endpoint with schemaIds 'builtin:host.monitoring' and 'builtin:host.monitoring.mode' instead. \
     * 
     * ---
     * @returns Deprecated. Manage host monitoring settings via the [Settings endpoint](index.jsp?urls.primaryName=Environment%20API%20v2#/Settings%20-%20Objects) with schemaId `builtin:host.monitoring` instead. Validates the payload for the `PUT /hosts/{id}/monitoring` request
     * @deprecated
     */
  ...
  symfiles = {
    /**
     * RUM - Mobile Deobfuscation and Symbolication \
     * `GET:/symfiles` \
     * Lists metadata of all symbol files from the Symbol File Store \
     * 
     * ---
     * @returns Symbol files are ProGuard files for Android or dSYM files for iOS.
     */
    ...
    /**
     * RUM - Mobile Deobfuscation and Symbolication \
     * `GET:/symfiles/{applicationId}/{packageName}/{os}/{versionCode}/{versionName}` \
     * Gets metadata of the symbol file for an app version \
     * 
     * ---
     * @returns Only one file per OS and version can exist.
     */
    getSingle: (
      applicationId: string,
      packageName: string,
    ...
    /**
     * RUM - Mobile Deobfuscation and Symbolication \
     * `PUT:/symfiles/{applicationId}/{packageName}/{os}/{versionCode}/{versionName}` \
     * Upload a symbol file \
     * 
     * ---
     * @returns The file should be either a ProGuard file for Android or a zip file containing all the iOS dSYM files.
     */
    createOrUpdate: (
      applicationId: string,
      packageName: string,
    ...
    /**
     * RUM - Mobile Deobfuscation and Symbolication \
     * `PUT:/symfiles/{applicationId}/{packageName}/{os}/{versionCode}/{versionName}/pinning` \
     * Pins/unpins all symbol files of an app version \
     * 
     * ---
     * @returns A pinned file will not be deleted automatically, when running out of space.
     */
