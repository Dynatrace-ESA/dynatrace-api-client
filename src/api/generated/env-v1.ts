 ...
 * @example {"configUrl":"http://coffee-machine.dynatrace.internal.com/coffeemachine/manage","displayName":"coffeeMachine","favicon":"https://www.freefavicon.com/freefavicons/food/cup-of-coffee-152-78475.png","group":"myCustomDeviceGroup","hostNames":["coffee-machine.dynatrace.internal.com"],"ipAddresses":["10.0.0.1"],"listenPorts":[80],"properties":{},"series":[{"dataPoints":[[1521542929000,13]],"dimensions":{"office":"Linz"},"timeseriesId":"custom:created.coffee.metric"}],"tags":["office-linz"],"type":"coffee machine"}
 */
 ...
 * @example {"annotationDescription":"The coffee machine is broken","annotationType":"defect","attachRules":{"entityIds":["CUSTOM_DEVICE-0000000000000007"],"tagRule":[{"meTypes":["HOST"],"tags":[{"context":"CONTEXTLESS","key":"customTag"}]}]},"end":1521542929000,"eventType":"CUSTOM_ANNOTATION","source":"OpsControl","start":1521042929000}
 */
...
* @example {"endTime":1521542929000,"entityId":"HOST-0000000000000007","entityName":"Example Host","eventStatus":"OPEN","eventType":"SLOW_DISK","id":"5915682011263205071_1521042929000","impactLevel":"INFRASTRUCTURE","severityLevel":"PERFORMANCE","source":"builtin","startTime":1521042929000,"tags":[{"context":"CONTEXTLESS","key":"exampleTag"}]}
*/
 ...
 * @example {"customParsingPatterns":"\"user %{STRING:User} logged\", \"job took %{INTEGER:Time} ms\"","parsingMode":"json"}
 */
 ...
 * @example {"collector":"string","java":"string","java_with_collector":"string","nodejs":"string","nodejs_with_collector":"string","python":"string","python_with_collector":"string"}
 */
 ...
 */
export interface OneAgentInstallerChecksum {
  /**
   * The checksum of the OneAgent installer.
   *
   * This is the sha256 hash of the installer file.
...
/**
 * @example {"fieldName":".Level","occurrences":[{"count":"100","value":"INFO"}]}
 */
...
* @example {"autoUpdateChromium":true,"availabilityLocationNodeOutageDelayInMinutes":5,"availabilityLocationOutage":false,"availabilityNodeOutage":false,"availabilityNotificationsEnabled":true,"deploymentType":"STANDARD","latitude":48.306351,"longitude":14.287399,"maxActiveGateCount":5,"minActiveGateCount":2,"name":"Linz Location","nodeSize":"S","nodes":["93302281"],"status":"ENABLED","type":"PRIVATE"}
*/
 ...
 * @example {"autoUpdateChromium":true,"availabilityNodeOutage":false,"availabilityNotificationsEnabled":true,"deploymentType":"STANDARD","isAvailabilityNodeOutage":false,"latitude":48.306351,"locationNodeOutageDelayInMinutes":5,"longitude":14.287399,"maxActiveGateCount":5,"minActiveGateCount":1,"name":"Linz Location","nodeSize":"S","nodes":["93302281"],"status":"ENABLED","type":"PRIVATE"}
 */
...
export interface ProcessGroup {
  ...
  managementZones?: EntityShortRepresentation[];
  metadata?: {
    "adobe.em.env_type"?: string[];
    "adobe.em.program"?: string[];
    "adobe.em.service"?: string[];
    "adobe.em.tier"?: string[];
    ...
    googleCloudInstanceId?: string[];
    googleCloudInstanceRegion?: string[];
    googleCloudProjects?: string[];
    googleCloudRunService?: string[];
  ...
  /** The list of entity tags. */
  tags?: TagInfo[];
  toRelationships?: { isInstanceOf?: string[]; isNetworkClientOfProcessGroup?: string[]; runsOn?: string[] };
}
...
export interface ProcessGroupInstance {
   ...
   */
  firstSeenTimestamp?: number;
  fromRelationships?: { isInstanceOf?: string[]; isNetworkClientOf?: string[]; isProcessOf?: string[] };
  ...
  /** The list of entity tags. */
  tags?: TagInfo[];
  toRelationships?: { isNetworkClientOf?: string[]; runsOnProcessGroupInstance?: string[] };
 ...
 * @example {"comment":"This is a comment!","context":"Slack","user":"user1"}
 */
...
export interface Service {
   ...
   */
  firstSeenTimestamp?: number;
  fromRelationships?: { calls?: string[]; runsOn?: string[]; runsOnProcessGroupInstance?: string[] };
  ...
  serviceDetectionAttributes?: Record<string, object>;
 ...
 * @example {"latitude":48.306351,"longitude":14.287399,"name":"Linz Location","nodes":["93302281"],"status":"ENABLED","type":"PRIVATE"}
 */
 ...
 * @example {"locations":[{"capabilities":["BROWSER","HTTP"],"cloudPlatform":"AMAZON_EC2","entityId":"GEOLOCATION-B8D793BCA914E0AF","ips":["134.189.153.97","134.189.153.98"],"name":"Gdansk","stage":"GA","status":"ENABLED","type":"PUBLIC"},{"entityId":"SYNTHETIC_LOCATION-53F47ECB33907667","name":"My private location","status":"ENABLED","type":"PRIVATE"}]}
 */
 ...
 * @example {"status":"ENABLED","type":"PUBLIC"}
 */
...
/**
 * Parameters of a single plugin or custom event threshold.
 * @example {"alertCondition":"ABOVE","dealertingSamples":1,"description":"The coffee machine must not produce a number of coffees {alert_condition} {threshold}.","enabled":true,"eventName":"Too many coffees made","eventType":"AVAILABILITY_EVENT","samples":1,"threshold":10000,"thresholdId":"tooManyCoffeesMade","timeseriesId":"received.coffees","violatingSamples":1}
 */
 ...
 * @example {"aggregationType":"AVG","dataPoints":{"HOST-0000000000000007":[[1522220334000,89]]},"entities":{"HOST-0000000000000007":"Laptop-8"},"resolutionInMillisUTC":300000,"timeseriesId":"com.dynatrace.builtin:host.cpu.idle","unit":"Percent"}
 */
 ...
 * @example {"aggregationTypes":["AVG","SUM","MIN","MAX"],"detailedSource":"Infrastructure","dimensions":["HOST"],"displayName":"CPU idle","filter":"BUILTIN","timeseriesId":"com.dynatrace.builting:host.cpu.idle","types":["Test"],"unit":"Percent","warnings":[]}
 */
 ...
 * @example {"aggregationType":"AVG","considerMaintenanceWindowsForAvailability":"false","endTimestamp":1521542929000,"entities":["HOST-0000000000000007"],"includeParentIds":"false","predict":true,"queryMode":"SERIES","relativeTime":"HOUR","startTimestamp":1521042929000,"tags":["office-linz"],"timeseriesId":"com.dynatrace.builtin:host.cpu.idle"}
 */
 ...
 * @example {"dimensions":["coffee"],"displayName":"received.coffees","types":["coffee machine"],"unit":"Count"}
 */
...
/**
 * Metadata of a token.
 * @example {"created":1554076800000,"expires":1585976400000,"id":"acbed0c4-4ef1-4303-991f-102510a69322","lastUse":1554354000000,"name":"myToken","personalAccessToken":true,"revoked":true,"scopes":["DataExport","ReadConfig","WriteConfig"],"userId":"john.smith"}
 */
 ...
 * @example {"columnNames":["city","avg(duration)","max(duration)"],"extrapolationLevel":1,"values":[["Klagenfurt","65996.75","129940"],["Linz","57360.86","222912"],["Gdansk","22482.2","351263"]]}
 */
export interface UsqlResultAsTable {
  /**
 ...
 * @example {"branchNames":["country","city"],"extrapolationLevel":1,"leafNames":["avg(duration)","max(duration)"],"values":{"Austria":{"Klagenfurt":["65996.75","129940"],"Linz":["57360.86","222912"]},"Poland":{"Gdansk":["22482.2","351263"]}}}
 */
export interface UsqlResultAsTree {
  /**
   * A list of columns in the additionalValues table.
   *
   *  Only present if the endpoint was called with `deepLinkFields=true` parameter.
 ...
 * @version 1.0.0
 * @baseUrl https://joh43990.sprint.dynatracelabs.com/api/v1
 *
 ...
 */
export class internalEnvV1 extends APIBase {
  anonymize = {
    /**
     * Anonymization \
  ...
  deployment = {
    ...
    getAgentInstallerConnectionInfo: (
      query?: { networkZone?: string; defaultZoneFallback?: boolean; version?: string },
      params: RequestParams = {},
    ) =>
    ...
    getAgentInstallerConnectionInfoEndpoints: (
      query?: { networkZone?: string; defaultZoneFallback?: boolean },
      params: RequestParams = {},
    ) =>
      this.request<void, any>({
    ...
    getAgentInstallerAvailableVersions: (
      ...
      installerType: "default" | "default-unattended" | "mainframe" | "paas" | "paas-sh",
      query?: {
    ...
    downloadLatestAgentInstaller: (
      ...
      query?: {
        ...
        arch?: "all" | "arm" | "ppc" | "ppcle" | "s390" | "sparc" | "x86";
        bitness?: "32" | "64" | "all";
        include?: ("all" | "java" | "apache" | "nginx" | "nodejs" | "dotnet" | "php" | "go" | "sdk" | "envoy")[];
     ...
     * 
     * ---
     * @returns If a [standard version](https://dt-url.net/ml03yye) is configured, then this is the downloaded version. Non-required parameters are only applicable to the `paas` and `paas-sh` installer types.
     */
     ...
     * 
     * ---
     * @returns The checksum is the sha256 hash of the installer file. Compare this checksum only with a non-customized OneAgent installer. To get a non-customized installer, set the **skipMetadata** query parameter of the download endpoint to `true`.
     */
    getAgentInstallerWithVersionChecksum: (
      ...
      this.request<OneAgentInstallerChecksum, void>({
        path: `/deployment/installer/agent/${osType}/${installerType}/version/${version}/checksum`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
    ...
    downloadLatestGatewayInstaller: (
      osType: "windows" | "unix",
      query?: { networkZone?: string; arch?: "all" | "amd64" | "s390" },
      params: RequestParams = {},
    ) =>
      this.request<void, void>({
     ...
     * 
     * ---
     * @returns Get the latest version names of the OneAgent for the Java, Node.js, and Python AWS Lambda runtimes, also including names for layers that are combined with the log collector, as well as for the standalone log collector layer.
     */
  ...
  userSessionQueryLanguage = {
    ...
    getUsqlResultAsTable: (
      ...
      this.request<UsqlResultAsTable, UserSession | void>({
    ...
    getUsqlResultAsTree: (
      ...
      this.request<UsqlResultAsTree, UserSession | void>({
